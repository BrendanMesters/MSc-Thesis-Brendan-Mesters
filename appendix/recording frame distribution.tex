...
The duration of each recording is roughly $\frac{1}{10}$th of the number of frames in the recording, since the mmWave radar records at 10 frames per second
