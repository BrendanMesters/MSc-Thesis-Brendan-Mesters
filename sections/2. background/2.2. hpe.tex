...
% \ednote{Clearly specify that \cite{munea2020progress} is a review paper, and that the following examples are taken from it "For a full overview..."}
Action recognition and tracking methods can control IoT systems, and HPE systems have even seen use in automated sign language recognition, assisted living spaces, and driver assistance systems, as shown by \citeauthor{munea2020progress} in their review paper~\cite{munea2020progress}.
...
And mmWave-radar-based methods often rely on Deep Learning methods to transform point clouds into post estimations.
% \ednote{According to who\\ Does this statement add anything?\\ Either remove it or put a source (Also, this is not a 'however')}
