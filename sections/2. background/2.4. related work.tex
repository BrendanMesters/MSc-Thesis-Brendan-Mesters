...
\textit{WaveTune} \cite{juneja2024wavetune}, which uses gestures to select a combination of prebuilt beat-patterns; and \textit{O Soli Mio} \cite{bernado2017o_soli_mio}, which allows you to control specific musical effects, or switch between different samples, by performing gestures above a sensor.
