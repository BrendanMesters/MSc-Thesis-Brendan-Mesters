...
To find the points near the hands, a sphere is constructed around the pointcloud, where the sphere's boundary follows the user's maximal reach.
...
After noise filtering, \textit{arm zones} can be specified as slices of the encompassing sphere.
An arm prediction is made based on the number of signal points in each zone.

% Why data enhancement?

The data from the mmWave sensor is relatively sparse, thus, it is important to get as much information from it as we can. 
This process is called \textit{data enhancement}.



The data from the mmWave sensor is relatively sparse, thus, it's important to get as much information out of this data as we can, this process is called \textit{data enhancement}.
