...
\begin{figure}[!htb]
    ...
    \caption{Internal data representation}
...
The point cloud is now divided into points contained within the six position zones and points not included in any position zone.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/misc/Zone expansion.png}
