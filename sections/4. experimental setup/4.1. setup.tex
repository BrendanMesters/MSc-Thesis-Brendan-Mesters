...
The radar requires firmware to run, a diverse variety of which are provided by TI, for varying sensing tasks.
...
\begin{figure}[!htb]
    ...
    \end{subfigure}
    \caption{The testing environment, providing the user view (a) and the sensor view (b).}
...
% - 
The experiments were performed in a large open room ($7 \times 10$~m). 
The mmWave~radar was mounted at a height of 125~cm and was tilted upwards at an angle of $5\degree$ upwards.
