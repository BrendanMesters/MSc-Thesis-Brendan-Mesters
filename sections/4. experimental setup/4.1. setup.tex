...
The whole experiment, consisting of between 4 and 7 recordings, took between 20 and 40 minutes.
During the recordings, both the mmWave radar point cloud and a skeletal estimation produced by the Kinect 2 were recorded.
The Kinect 2 did record a video channel, but this video channel was only used to create the skeletal estimate and was never saved.
While in use, the system produced musical notes in accordance with the pose that the system predicted at that given time.
The users were given a content form before the experiment, and were allowed to drop out of the experiment at any point.
