...
The script was designed to be simple to follow for the user by following a logical pattern while also covering every transition between distinct arm angle estimations.
