...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\linewidth]{figures/results/Position State Likelyhood baseline paper calib.png}
...
mmWave radars produce slightly different pointclouds in different rooms, as mentioned in \cref{section: background - millimetre wave radar}, which can alter small secondary patterns in the pointclouds, mostly with respect to the noise and reflections in the room.
