...
The fact that a significant percentage of frames are estimated with low latency suggests that the high latency issue is not inherent to the method, but rather an implementation-specific issue.
